                    ...
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
						...
						<%
							...
							String sql = "select count(meet_id) as task_inc from active_meet where emp_id='" + emp_id + "' and (status='Assigned' or status='TBV')";
							ResultSet rs = DBUtil.executeQuery(sql);
							while(rs.next()) {
								String ver = "select count(meet_id) as task_comp from active_meet where emp_id='" + emp_id + "' and status='Completed'";
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Pending Meetings</div>
						<%
							emp_id = (String)session.getAttribute("man_id");
							sql = "select count(meet_id) as meet_count from active_meet where emp_id='" + emp_id + "' and status='Assigned'";
