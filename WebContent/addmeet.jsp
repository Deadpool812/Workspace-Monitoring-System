...
<body onload="alert_msg(jsonString)" id="page-top">
	<script>
		function alert_msg (jsonString) {
			...
			if(json == null || json.flag == 0) {
				...
				document.getElementById("alert").innerHTML = "<div class='alert alert-success'>Meeting request successful!</div>";
			}
			else if(json.flag == 2) {
      ...
      <li class="nav-item">
        <a class="nav-link" href="CustHome.jsp">
		  ...
		  <li class="nav-item active">
			<a class="nav-link" href="cust_meet.jsp" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
			  <i class="fa fa-users"></i>
			  <span>Meetings</span>
			</a>
			<div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
			  <div class="bg-white py-2 collapse-inner rounded" >
				<a class="collapse-item active" href="addmeet.jsp">Request</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Schedule a meeting</h1>
          </div>
				<div id="alert"></div>
				<div id="reg_table">
					<form action="addMeet" method="post">
						<div class="form-group">
							<label for="title">Meeting Title</label> <input type="text"
						...
						<div class="form-group">
							<label for="desc">Description</label> <input type="text"
								name="desc" id="desc" placeholder="Enter Description"
								class="form-control" required="true">
						</div>
						<div class="form-group">
							<label for="footnotes">Footnotes</label> <input type="text"
								name="footnotes" id="footnotes"
								placeholder="Enter any footnotes" class="form-control">
						</div>
						<div class="form-group">
							<label for="sched-date">Date of meeting</label> <input
								type="date" name="sched-date" id="sched-date"
								placeholder="Enter a date" class="form-control">
						</div>
						<div class="form-group">
							<label for="sched-time">Time of meeting</label> <input
								type="time" name="sched-time" id="sched-time"
								placeholder="Enter a time" class="form-control">
						</div>
